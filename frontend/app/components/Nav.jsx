...
const Nav = () => {
    return (
        <div className='flex justify-between items-center border-b-[1px] border-gray-200 py-4 shadow-md'>
            ...
            <div className='mr-10'>
                <Link href="/about"><span className='mx-3 text-sm sm:text-md cursor-pointer'>About</span></Link>
                <Link href="/people"><span className='mx-3 text-sm sm:text-md cursor-pointer'>People</span></Link>
                <Link href="/research"><span className='mx-3 text-sm sm:text-md cursor-pointer'>Academic Work</span></Link>
